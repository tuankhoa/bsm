$(function () {
    $('#search').click(function () {
        $('#tableHistory').html(`<table id="dataHistory" class="table table-striped table-bordered text-center"><thead class="thead-dark"><tr><th scope="col">STT</th><th scope="col">Ngày</th><th scope="col">Tháng</th><th scope="col">Năm</th><th scope="col">Số giờ làm</th><th scope="col">Ghi chú</th></tr></thead><tbody></tbody></table>`)
